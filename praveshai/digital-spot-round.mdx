...
<Steps>
  <Step title="Pre-session — eligibility and queue position">
    ...
    <Frame>
      <img
        ...
        alt="Spot round pre-session screen"
        src="/images/5_1_beforesr_l.png"
      />
      <img
        className="hidden dark:block"
        alt="Spot round pre-session screen"
        src="/images/5_1_beforesr_d.png"
      />
    </Frame>
  </Step>
  <Step title="Session live — seat board and queue">
    ...
    <Frame>
      <img
        className="block dark:hidden"
        alt="Live spot round seat board"
        src="/images/5_2_seatboard_l.png"
      />
      <img
        className="hidden dark:block"
        alt="Live spot round seat board"
        src="/images/5_2_seatboard_d.png"
      />
    </Frame>
  </Step>
  <Step title="Your turn — select a seat">
    ...
    <Frame>
      <img
        ...
        src="/images/5_3_youturn_l.png"
      />
      <img
        className="hidden dark:block"
        alt="Seat selection with timer"
        src="/images/5_3_youturn_d.png"
      />
    </Frame>
  </Step>
  <Step title="Seat confirmed">
    ...
    <Frame>
      <img
        ...
        src="/images/5_4_seatconfirm_l.png"
      />
      <img
        className="hidden dark:block"
        alt="Seat confirmed screen"
        src="/images/5_4_seatconfirm_d.png"
      />
    </Frame>
  </Step>
</Steps>
