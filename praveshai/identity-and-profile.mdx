  ...
  <Step title="Verify your Aadhaar">
    ...
    <Frame>
      <img
        ...
        src="/images/1_1_verify_aadhar_l.png"
        title="1 1 Verify Aadhar 1"
      />
      <img
        className="hidden dark:block"
        alt="1 1 Verify Aadhar 1"
        src="/images/1_1_verify_aadhar_d.png"
        title="1 1 Verify Aadhar 1"
      />
    </Frame>
  </Step>
  <Step title="Confirm mobile access">
    ...
    <Frame>
      <img
        ...
        src="/images/1_2_verification_code_l.png"
        title="1 2 Verification Code"
      />
      <img
        className="hidden dark:block"
        alt="1 2 Verification Code"
        src="/images/1_2_verification_code_d.png"
        title="1 2 Verification Code"
      />
    </Frame>
  </Step>
  <Step title="Fetch verified records">
    ...
    <Frame>
      <img
        ...
        src="/images/1_3_records_fetch_l.png"
        title="1 3 Records Fetch"
      />
      <img
        className="hidden dark:block"
        alt="1 3 Records Fetch"
        src="/images/1_3_records_fetch_d.png"
        title="1 3 Records Fetch"
      />
    </Frame>
  </Step>
  <Step title="Your Access ID is ready">
    ...
    <Frame>
      <img
        className="block dark:hidden"
        alt="1 4 Accessid"
        src="/images/1_4_accessid_l.png"
        title="1 4 Accessid"
      />
      <img
        className="hidden dark:block"
        alt="1 4 Accessid"
        src="/images/1_4_accessid_d.png"
        title="1 4 Accessid"
      />
    </Frame>
  </Step>
  <Step title="Create your security PIN">
    ...
    <Frame>
      <img
        className="block dark:hidden"
        alt="1 5 Create Mpin"
        src="/images/1_5_create_mpin_l.png"
        title="1 5 Create Mpin"
      />
      <img
        className="hidden dark:block"
        alt="1 5 Create Mpin"
        src="/images/1_5_create_mpin_d.png"
        title="1 5 Create Mpin"
      />
    </Frame>
  </Step>
