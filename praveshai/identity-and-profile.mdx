...
<Frame caption="Step 2 — OTP sent to the Aadhaar-linked mobile number for identity confirmation">
  <img src="/images/onboarding-otp.jpg" alt="OTP verification screen" />
</Frame>
...
<Frame caption="Step 3 — DigiLocker fetch in progress. Aadhaar, APAAR, marksheets, and exam scores retrieved from issuing authorities. Category certificate flagged for manual review.">
  <img src="/images/onboarding-digilocker-fetch.jpg" alt="DigiLocker document fetch with verification statuses" />
</Frame>
...
<Frame caption="Step 4 — The verified student profile. Access ID ready to use across all counsellings.">
  <img src="/images/onboarding-access-id.jpg" alt="Access ID card with student profile and QR code" />
</Frame>
