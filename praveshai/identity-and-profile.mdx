...
<Steps>
  <Step title="Verify your Aadhaar">
    ...
    <Frame>
      ![Aadhaar verification screen](/images/1_1_verify_aadhar.png)
    </Frame>
  </Step>
  <Step title="Confirm mobile access">
    ...
    <Frame>
      ![OTP verification screen](/images/1_2_verification_code.png)
    </Frame>
  </Step>
  <Step title="Fetch verified records">
    ...
    <Frame>
      ![DigiLocker document fetch](/images/1_3_records_fetch.png)
    </Frame>
  </Step>
  <Step title="Your Access ID is ready">
    ...
    <Frame>
      ![Access ID card](/images/1_4_accessid.png)
    </Frame>
  </Step>
  <Step title="Create your security PIN">
    ...
    <Frame>
      ![MPIN creation screen](/images/1_5_create_mpin.png)
    </Frame>
  </Step>
</Steps>
