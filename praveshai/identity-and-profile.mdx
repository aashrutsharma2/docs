...
<Steps>
  <Step title="Verify your Aadhaar">
    ...
    <Frame>
      <img
        ...
        alt="1 1 Verify Aadhar 1"
        title="1 1 Verify Aadhar 1"
        src="/images/1.1_verify_aadhar_l.png"
      />
      <img
        className="hidden dark:block"
        alt="1 1 Verify Aadhar 1"
        title="1 1 Verify Aadhar 1"
        src="/images/1.1_verify_aadhar_d.png"
      />
    </Frame>
  </Step>
  <Step title="Confirm mobile access">
    ...
    <Frame>
      <img
        className="block dark:hidden"
        alt="1 2 Verification Code"
        title="1 2 Verification Code"
        src="/images/1.2_verification_code_l.png"
      />
      <img
        className="hidden dark:block"
        alt="1 2 Verification Code"
        title="1 2 Verification Code"
        src="/images/1.2_verification_code_d.png"
      />
    </Frame>
  </Step>
  <Step title="Fetch verified records">
    ...
    <Frame>
      <img
        className="block dark:hidden"
        alt="1 3 Records Fetch"
        title="1 3 Records Fetch"
        src="/images/1.3_records_fetch_l.png"
      />
      <img
        className="hidden dark:block"
        alt="1 3 Records Fetch"
        title="1 3 Records Fetch"
        src="/images/1.3_records_fetch_d.png"
      />
    </Frame>
  </Step>
  <Step title="Your Access ID is ready">
    A verified student profile is created and linked to a unique Access ID. Use it across every participating counselling.
    ...
    <Frame>
      <img
        ...
        alt="1 4 Accessid"
        title="1 4 Accessid"
        src="/images/1.4_accessid_l.png"
      />
      <img
        className="hidden dark:block"
        alt="1 4 Accessid"
        title="1 4 Accessid"
        src="/images/1.4_accessid_d.png"
      />
    </Frame>
  </Step>
  <Step title="Create your security PIN">
    ...
    <Frame>
      <img
        className="block dark:hidden"
        alt="1 5 Create Mpin"
        title="1 5 Create Mpin"
        src="/images/1.5_create_mpin_l.png"
      />
      <img
        className="hidden dark:block"
        alt="1 5 Create Mpin"
        title="1 5 Create Mpin"
        src="/images/1.5_create_mpin_d.png"
      />
    </Frame>
  </Step>
</Steps>
