...
<Frame caption="Applications workspace — choice filling with PraveshAI™ safety scores, filters by branch and category, autosave active, and lock deadline countdown">
  <img
    className="block dark:hidden"
    alt="Applications workspace"
    src="/images/3_applications_l.png"
  />
  <img
    className="hidden dark:block"
    alt="Applications workspace"
    src="/images/3_applications_d.png"
  />
</Frame>
...
<Frame caption="Choice filling detail — institute list with previous year OBC closing rank and annual fee, priority order on the right, completion status and submission readiness at the bottom">
  <img
    className="block dark:hidden"
    alt="Choice filling detail view"
    src="/images/3_1_choicefilling_l.png"
  />
  <img
    className="hidden dark:block"
    alt="Choice filling detail view"
    src="/images/3_1_choicefilling_d.png"
  />
</Frame>
...
<Frame caption="Choice filling workspace — institute list with PraveshAI™ safety scores, drag-and-drop priority ordering, and autosave every 30 seconds">
  ![Choice filling interface with safety scores](/images/9_choice_filling_cu.png)
</Frame>
