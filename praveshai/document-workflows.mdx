...
icon: "file-check"
description: "Verified once. Reused across every integrated counselling systems."
mode: "wide"
---
...
```
<Frame caption="The student document vault — Core Identity, Academic Records, and Category Documents fetched from issuing authorities. Manual review flagged where auto-verification is unavailable.">
  <img src="/images/documents-vault.jpg" alt="Document vault with verification status per document" />
</Frame>
