...
icon: "file-check"
description: "Students upload and verify documents once via DigiLocker. The same verified documents are accepted across every participating admission portal, institution dashboard, and counselling authority — no re-upload required."
mode: "wide"
...
<Info>
  Guidance and Support covers what PraveshAI™ does with the verified profile — how sends smart alerts, and assists students through choice filling and entire admission saga.
</Info>