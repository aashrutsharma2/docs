...
The officer's actions are all logged. Every decision has a timestamped record tied to the officer's account.**The verification signal organises human attention.** Officers spend time on the cases that need it, not on uniform blind review of everything.
