...
flowchart LR
    ...
    %% Cohesive Palette Stylings %%
    style S fill:#e0e7ff,stroke:#4f46e5,stroke-width:2px,color:#1e1b4b
    ...
    style ST fill:#ffffff,stroke:#4f46e5,color:#1e1b4b
    style ID fill:#ffffff,stroke:#2563eb,color:#1e3a8a
    style G fill:#ffffff,stroke:#2563eb,color:#1e3a8a
    style WF fill:#ffffff,stroke:#2563eb,color:#1e3a8a
    style PAY fill:#ffffff,stroke:#2563eb,color:#1e3a8a
    style R fill:#ffffff,stroke:#64748b,color:#0f172a
    style M fill:#ffffff,stroke:#64748b,color:#0f172a
    style RD fill:#ffffff,stroke:#64748b,color:#0f172a
    style AL fill:#ffffff,stroke:#64748b,color:#0f172a
```
