...
<Tabs>
  <Tab title="Account">
    <img
      ...
      src="/images/7.1_saccount_l_copy.png"
    />
    <img
      className="hidden dark:block"
      alt="Account settings"
      src="/images/7.1_saccount_d_copy.png"
    />
  </Tab>
  <Tab title="Security">
    <img
      ...
      src="/images/7.2_ssecurity_l_copy.png"
    />
    <img
      className="hidden dark:block"
      alt="Security settings"
      src="/images/7.2_ssecurity_d_copy.png"
    />
  </Tab>
  <Tab title="Privacy">
    <img
      ...
      src="/images/7.3_sprivacy_l_copy.png"
    />
    <img
      className="hidden dark:block"
      alt="Privacy settings"
      src="/images/7.3_sprivacy_d_copy.png"
    />
  </Tab>
  <Tab title="Notifications">
    <img
      ...
      src="/images/7.4_snotification_l_copy.png"
    />
    <img
      className="hidden dark:block"
      alt="Notification settings"
      src="/images/7.4_snotification_d_copy.png"
    />
  </Tab>
  <Tab title="Integrations">
    <img
      ...
      src="/images/7.5_sintegrations_l_copy.png"
    />
    <img
      className="hidden dark:block"
      alt="Integrations settings"
      src="/images/7.5_sintegrations_d_copy.png"
    />
  </Tab>
  <Tab title="Trust & Compliance">
    <img
      ...
      src="/images/7.6_trust_l_copy.png"
    />
    <img
      className="hidden dark:block"
      alt="Trust and compliance"
      src="/images/7.6_trust_d_copy.png"
    />
  </Tab>
  <Tab title="Accessibility">
    <img
      ...
      src="/images/7.7_saccesibility_l_copy.png"
    />
    <img
      className="hidden dark:block"
      alt="Accessibility settings"
      src="/images/7.7_saccesibility_d_copy.png"
    />
  </Tab>
  <Tab title="Power Features">
    <img
      className="block dark:hidden"
      alt="Power features"
      src="/images/7.8_powerfet_l_copy.png"
    />
    <img
      className="hidden dark:block"
      alt="Power features"
      src="/images/7.8_powerfet_d_copy.png"
    />
  </Tab>
</Tabs>
