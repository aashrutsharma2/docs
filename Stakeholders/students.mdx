---
title: "Students"
description: "How Superadmission serves students: one Aadhaar login, one verified admissions profile, one workspace to manage applications, documents, deadlines, and seat allotments across every counselling portal in India."
icon: "user-pen"
mode: "wide"
keywords: ["student admission portal India", "apply multiple colleges one login India", "Aadhaar student admission India", "single dashboard all counselling portals", "student workspace admissions India", "college application portal India", "admission tracker student India", "JEE student admission portal", "NEET student admission portal", "online college admission India"]
---
...
<Frame>
  <img
    alt="Students appearing in major entrance exams"
    className="block dark:hidden"
    src="/images/participation-light.svg"
  />
  <img
    alt="Students appearing in major entrance exams"
    className="hidden dark:block"
    src="/images/participation-dark.svg"
  />
</Frame>
...
<Frame>
  <img
    alt="Students dropoff through admissions process"
    className="block dark:hidden"
    src="/images/dropout-light.svg"
  />
  <img
    alt="Students dropoff through admissions process"
    className="hidden dark:block"
    src="/images/dropout-dark.svg"
  />
</Frame>
...
<Tabs>
  <Tab title="Account">
    <img
      ...
      src="/images/7.1_saccount_l copy.png"
    />
    <img
      className="hidden dark:block"
      alt="Account settings"
      src="/images/7.1_saccount_d copy.png"
    />
  </Tab>
  <Tab title="Security">
    <img
      ...
      src="/images/7.2_ssecurity_l copy.png"
    />
    <img
      className="hidden dark:block"
      alt="Security settings"
      src="/images/7.2_ssecurity_d copy.png"
    />
  </Tab>
  <Tab title="Privacy">
    <img
      ...
      src="/images/7.3_sprivacy_l copy.png"
    />
    <img
      className="hidden dark:block"
      alt="Privacy settings"
      src="/images/7.3_sprivacy_d copy.png"
    />
  </Tab>
  <Tab title="Notifications">
    <img
      ...
      src="/images/7.4_snotification_l copy.png"
    />
    <img
      className="hidden dark:block"
      alt="Notification settings"
      src="/images/7.4_snotification_d copy.png"
    />
  </Tab>
  <Tab title="Integrations">
    <img
      ...
      src="/images/7.5_sintegrations_l copy.png"
    />
    <img
      className="hidden dark:block"
      alt="Integrations settings"
      src="/images/7.5_sintegrations_d copy.png"
    />
  </Tab>
  <Tab title="Trust & Compliance">
    <img
      className="block dark:hidden"
      alt="Trust and compliance"
      src="/images/7.6_trust_l copy.png"
    />
    <img
      className="hidden dark:block"
      alt="Trust and compliance"
      src="/images/7.6_trust_d copy.png"
    />
  </Tab>
  <Tab title="Accessibility">
    <img
      ...
      src="/images/7.7_saccesibility_l copy.png"
    />
    <img
      className="hidden dark:block"
      alt="Accessibility settings"
      src="/images/7.7_saccesibility_d copy.png"
    />
  </Tab>
  <Tab title="Power Features">
    <img
      className="block dark:hidden"
      alt="Power features"
      src="/images/7.8_powerfet_l copy.png"
    />
    <img
      className="hidden dark:block"
      alt="Power features"
      src="/images/7.8_powerfet_d copy.png"
    />
  </Tab>
</Tabs>
