...
## A Few Words That Need Precise Meaning

**Round.** Counselling does not happen once and finish. It happens in rounds, usually somewhere between two and six, spread over several weeks. Round 1 matches seats to the highest-ranked students first. Whatever seats are left over carry into round 2, and so on. A seat that was not available in round 1 can become available in round 3, once higher-ranked students who got better options have already moved on.

**Spot round.** After all the scheduled rounds are done, if seats are still empty, one final round opens with very short notice, sometimes just a day or two. This exists because a large number of seats go unfilled every year even after all the regular rounds. As one example, more than 10,000 MBBS seats were left unfilled after two full rounds of MCC counselling in a single year. A seat existing does not mean it gets filled.

**Declining an allotted seat.**

<Note>
  If a student is matched to a seat and decides not to accept it, no money is lost. The offer simply lapses, and the seat goes back into the pool for the next round. A common misunderstanding is that saying no to a seat forfeits money already paid. It does not.
</Note>
