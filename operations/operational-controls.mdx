...
description: "Round-level and system-level controls — what they do, who can use them, and what gets logged."
---
...
<img src="/images/samplescreenshot.jpg" alt="[SCREENSHOT NEEDED: Authority round control panel — showing round status, pause/resume button, deadline extension input, and last action log]" />
