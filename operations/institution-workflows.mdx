...
description: "How institutions use Superadmission: a centralised dashboard for managing verified student records, admission decisions, document workflows, and audit trails — without changing existing admission rules."
icon: "school"
mode: "wide"
