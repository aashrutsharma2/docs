...
description: "Real-time round health, seat fill visibility, and post-round data."
icon: "chart-line"
---

Counselling authorities get a live operational view throughout a round — not just final numbers after it closes.

---

## Real-time seat fill

<img src="/images/samplescreenshot.jpg" alt="[SCREENSHOT NEEDED: Authority dashboard — seat fill rate view showing category-wise fill percentages as a bar or ring chart, updated live]" />
...
<img src="/images/samplescreenshot.jpg" alt="[SCREENSHOT NEEDED: Post-round summary report view — showing the round summary card with fill rate breakdown, acceptance stats, and download button]" />
