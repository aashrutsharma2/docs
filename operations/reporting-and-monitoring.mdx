...
![\[SCREENSHOT NEEDED: Authority dashboard — seat fill rate view showing category-wise fill percentages as a bar or ring chart, updated live\]](/images/samplescreenshot.jpg)
...
| By category | SC / ST / OBC / EWS / General — separately |
| By round | Current round vs prior rounds |

No waiting for a round to close to see how it is tracking.
...
<CardGroup cols={2}>
  ...
  <Card title="Allocation validation status" icon="shield-check">
    After a run — how many records passed clean, how many were quarantined, what was published.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Verification log" icon="file-lines">
    All document decisions — officer, timestamp, outcome
  </Card>
...
- Allocation validation summary — records passed, quarantined, published

![\[SCREENSHOT NEEDED: Post-round summary report view — showing the round summary card with fill rate breakdown, acceptance stats, and download button\]](/images/samplescreenshot.jpg)

<Tip>
  **Post-round data accumulates across cycles.** Year-on-year comparisons become available after the first full cycle, giving authorities a longitudinal view of their seat fill patterns and operational health.
</Tip>

---

<Info>
  When something goes wrong during a round — a student dispute, a verification dispute, or an operational issue — the resolution path is in Grievance and Escalation.
</Info>