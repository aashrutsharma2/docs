...
description: "How disputes are submitted, routed, reviewed, and resolved."
---

Most grievances in admissions trace to two things: a document rejected without a clear reason, or an allocation outcome that cannot be explained. Superadmission's design reduces both. When a grievance does occur, the resolution path is structured — not a help desk inbox.
...
<img src="/images/samplescreenshot.jpg" alt="[SCREENSHOT NEEDED: Student grievance submission screen — showing type dropdown, reference field, and details text area]" />
...
<img src="/images/samplescreenshot.jpg" alt="[SCREENSHOT NEEDED: Authority grievance summary panel — showing open/resolved/escalated counts by type, with a trend line for the current round]" />
