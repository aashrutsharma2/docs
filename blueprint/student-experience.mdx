...
<Frame caption="The student overview — all active counsellings, document status, current stage, and next deadline in a single view">
  <img
    ...
    src="/images/2_1_dashboard_l.png"
  />
  <img
    className="hidden dark:block"
    alt="Student dashboard overview"
    src="/images/2_1_dashboard_d.png"
  />
</Frame>
...
<CardGroup cols={2}>
  <Frame caption="One-view strip — profile, rank, category, and live status indicators">
    <img
      className="block dark:hidden"
      alt="One-view profile strip"
      src="/images/2_2_oneview_l.png"
    />
    <img
      className="hidden dark:block"
      alt="One-view profile strip"
      src="/images/2_2_oneview_d.png"
    />
  </Frame>

  <Frame caption="Counselling switcher — jump between JoSAA, JAC Delhi, CUET, WBJEE, MHT-CET and more">
    <img
      className="block dark:hidden"
      alt="Counselling switcher"
      src="/images/2_3_counsellingswitch_l.png"
    />
    <img
      className="hidden dark:block"
      alt="Counselling switcher"
      src="/images/2_3_counsellingswitch_d.png"
    />
  </Frame>
</CardGroup>
...
<CardGroup cols={2}>
  <Frame caption="Month view — deadline dots plotted on calendar">
    <img
      ...
      src="/images/2_4_calendar_l.png"
    />
    <img
      className="hidden dark:block"
      alt="Calendar month view"
      src="/images/2_4_calendar_d.png"
    />
  </Frame>

  <Frame caption="Upcoming panel — all deadlines across counsellings with countdown">
    <img
      className="block dark:hidden"
      alt="Upcoming deadlines panel"
      src="/images/2_5_sync_l.png"
    />
    <img
      className="hidden dark:block"
      alt="Upcoming deadlines panel"
      src="/images/2_5_sync_d.png"
    />
  </Frame>
</CardGroup>

<CardGroup cols={2}>
  <Frame caption="Calendar sync — one-tap Google Calendar export for any counselling deadline">
    <img
      className="block dark:hidden"
      alt="Calendar sync modal"
      src="/images/2_5_calsync_l.png"
    />
    <img
      className="hidden dark:block"
      alt="Calendar sync modal"
      src="/images/2_5_calsync_d.png"
    />
  </Frame>

  <Frame caption="Notifications — seat allotments, document verifications, and deadline alerts">
    <img
      className="block dark:hidden"
      alt="Notifications panel"
      src="/images/2_6_notifications_l.png"
    />
    <img
      className="hidden dark:block"
      alt="Notifications panel"
      src="/images/2_6_notifications_d.png"
    />
  </Frame>
</CardGroup>

<Frame>
  ![6 Dashboard 1](/images/6_dashboard-1.png)
</Frame>
