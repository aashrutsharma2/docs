...
<Note>
  Superadmission is not a counselling system. It proposes a shared infrastructure layer — identity, documents, workflow, guidance that removes the coordination burden currently carried by the student.
</Note>
