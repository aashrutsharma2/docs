...
<Steps>
  ...
  <Step title="Policy clearance">
    For central authorities  any formal integration is likely to require clearance from the relevant ministries. Ministry of Education for engineering counselling. Ministry of Health for medical counselling. This process has its own timeline and involves actors beyond the authority itself.
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Allocation logic simulation" icon="seat-airline-window">
...
3. **State-level pilot conversation** : State counselling systems are operationally simpler than JoSAA and MCC, and state government engagement is a different process than central ministry engagement. A state pilot would produce real operational learning without requiring central authority buy-in first.
