...
<Info>
  This is what Superadmission proposes to provide. An infrastructure layer that makes the student's interaction with each counselling system materially simpler without requiring any authority to change how it allocates seats.
</Info>
