...
Fixing any one of these in isolation a better portal, a unified calendar app, a document upload helper treats a symptom. The underlying problem is the absence of a coordination layer that sits across systems and removes the coordination burden from the student.
